<?php
	...
	/**
	* Finds the user in the DB for login/register
	*/
	class User
	{
		private $con;
		...
		public static function Find($email, $return_assoc = false){
			...
			$findUser = $con->prepare("SELECT user_id, password, confirmed FROM users WHERE email = LOWER(:email) LIMIT 1");
